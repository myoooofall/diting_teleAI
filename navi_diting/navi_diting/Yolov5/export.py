...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/P_detection.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='/storage/A_Yolov5/runs/train_Pdetection/exp3/weights/last.pt', help='model.pt path(s)')
