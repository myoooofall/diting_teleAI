...
def run(
        ...
        depth_source = ROOT / 'data/depths', #单独存放深度图
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/diting/liang/ros2_ws/src/navi_diting/navi_diting/Yolov5/weights/best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default='/home/diting/liang/ros2_ws/src/navi_diting/navi_diting/Yolov5/data/images', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--depth_source', type=str, default='/home/diting/liang/ros2_ws/src/navi_diting/navi_diting/Yolov5/data/depths', help='(optional) dataset.yaml path')
    parser.add_argument('--data', type=str, default='/home/diting/liang/ros2_ws/src/navi_diting/navi_diting/Yolov5/data/Product.yaml', help='(optional) dataset.yaml path')
